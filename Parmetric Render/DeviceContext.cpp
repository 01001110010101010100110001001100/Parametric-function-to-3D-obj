...
DeviceContext::DeviceContext(ID3D11DeviceContext* device_context,RenderChicken* chicken) : m_chicken(chicken),m_device_context(device_context) {
...
void DeviceContext::setConstBuffer(const VertexShaderPtr& vertex_shader, const ConstBufferPtr& buffer) {
	m_device_context->VSSetConstantBuffers(0, 1, &buffer->m_buffer);
}

void DeviceContext::setConstBuffer(const PixelShaderPtr& pixel_shader, const ConstBufferPtr& buffer) {
